        ...
        if (message != nil) {
            ...
            switch (logMessage->_type) {
                case TDLoggingLevelDebug:
                    os_log_debug(logger, "[Debug] %{public}s", msg);
                    break;
                case TDLoggingLevelInfo:
                    os_log_info(logger, "[Info] %{public}s", msg);
                    break;
                case TDLoggingLevelError:
                    os_log_error(logger, "[Error] %{public}s", msg);
                    break;
                case TDLoggingLevelWarning:
                    os_log_error(logger, "[Warning] %{public}s", msg);
                    break;
