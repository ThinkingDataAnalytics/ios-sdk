...
- (void)setData
{
    [[ThinkingAnalyticsSDK sharedInstance] enableAutoTrack:ThinkingAnalyticsEventTypeAll params:@{@(ThinkingAnalyticsEventTypeAll): @{@"auto_track_custom_key": @"auto_track_custom_value"}}];
