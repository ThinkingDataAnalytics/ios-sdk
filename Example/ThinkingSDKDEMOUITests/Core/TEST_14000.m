...
// 每一并发执行的数量
#define TEST_MaxNumEvents 5000

@interface TEST_14000 ()

@property(nonatomic, strong)TDMutiThread *mutiThread;
...
- (void)setUp {
    ...
    self.mutiThread = [[TDMutiThread alloc] init];
