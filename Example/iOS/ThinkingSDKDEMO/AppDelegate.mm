...
//    config.debugMode = ThinkingAnalyticsDebug;
    ...
    config.loadSecretKey = ^TDSecretKey* (void) {
        return [[TDSecretKey alloc] initWithKey:@""
                                        version:1.0 asymmetricEncryptType:@"RSA" symmetricEncryptType:@"AES"];
    };
...
//
//    /*如果没有则写NULL*/
//    pthread_create(&ntid, &atrr, inc_count,   (void *)&thread_ids[0]);
//    
    
    
//    dispatch_async(_queue1, ^{
//        for (int i = 1000; i>0; i--) {
//           NSDictionary *dic = [[[ThinkingAnalyticsSDK sharedInstance] getPresetProperties] toEventPresetProperties];
//            NSLog(@"%@", dic);
//        };
//    });
//    
