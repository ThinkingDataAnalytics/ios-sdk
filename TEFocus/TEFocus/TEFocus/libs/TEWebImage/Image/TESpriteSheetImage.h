...
/**
 ...
 Sample Code:
    ...
    TESpriteSheetImage *sprite;
    sprite = [[TESpriteSheetImage alloc] initWithSpriteSheetImage:img
                                                     contentRects:contentRects
                                                   frameDurations:durations
                                                        loopCount:0];
    TEAnimatedImageView *imgView = [TEAnimatedImageView new];
