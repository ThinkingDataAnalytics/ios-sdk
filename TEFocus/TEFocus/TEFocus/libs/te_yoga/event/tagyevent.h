...
struct TA_YOGA_EXPORT Event {
  ...
  class Data;
  using Subscriber = void(const TAYGNode&, Type, Data);
  ...
  template <Type E>
  static void publish(const TAYGNode& node, const TypedData<E>& eventData = {}) {
...
private:
  static void publish(const TAYGNode&, Type, const Data&);
};
