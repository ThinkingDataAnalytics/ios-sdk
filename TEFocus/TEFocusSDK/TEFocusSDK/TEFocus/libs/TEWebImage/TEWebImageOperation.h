...
/**
 The TEWebImageOperation class is an NSOperation subclass used to fetch image 
 from URL request.
 ...
 */
@interface TEWebImageOperation : NSOperation
...
@property (nullable, nonatomic, strong, readonly) TEImageCache      *cache;    ///< The image cache.
@property (nonatomic, strong, readonly)           NSString          *cacheKey; ///< The image cache key.
@property (nonatomic, readonly)                   TEWebImageOptions options;   ///< The operation's option.
...
- (instancetype)initWithRequest:(NSURLRequest *)request
                        options:(TEWebImageOptions)options
                          cache:(nullable TEImageCache *)cache
                       cacheKey:(nullable NSString *)cacheKey
                       progress:(nullable TEWebImageProgressBlock)progress
                      transform:(nullable TEWebImageTransformBlock)transform
                     completion:(nullable TEWebImageCompletionBlock)completion NS_DESIGNATED_INITIALIZER;
