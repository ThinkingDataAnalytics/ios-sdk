...

{
    ...
    if (!pUncompressedData || [pUncompressedData length] == 0) {
        ...
        NSLog(@"[ThinkingAnalytics] %s: Error: Can't compress an empty or nil NSData object",__func__);
    ...
    if (initError != Z_OK) {
        ...
        NSLog(@"[ThinkingAnalytics] %s:deflateInit2() Error: \"%@\" Message: \"%s\"",__func__,errorMsg,zlibStreamStruct.msg);
...
//        NSLog(@"[ThinkingAnalytics] %s:zlib error while attempting compression: \"%@\" Message: \"%s\"", __func__, errorMsg, zlibStreamStruct.msg);
...
//    NSLog(@"[ThinkingAnalytics] %s: Compressed file from %lu B to %d B", __func__, (unsigned long)[pUncompressedData length], [compressedData length]);
