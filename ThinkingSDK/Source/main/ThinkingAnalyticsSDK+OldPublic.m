...
- (void)setTrackStatus: (TATrackStatus)status {
    [TDAnalytics setSDKStatus:(TDTrackStatus)status withAppId:[self instanceAliasNameOrAppId]];
}
- (void)enableTracking:(BOOL)enabled {
    [TDAnalytics setSDKStatus:enabled ? TDTrackStatusNormal : TDTrackStatusPause withAppId:[self instanceAliasNameOrAppId]];
}
- (void)optOutTracking {
    [TDAnalytics setSDKStatus:TDTrackStatusStop withAppId:[self instanceAliasNameOrAppId]];
}
...
- (void)optInTracking {
    [TDAnalytics setSDKStatus:TDTrackStatusNormal withAppId:[self instanceAliasNameOrAppId]];
}
...
- (void)enableThirdPartySharing:(TAThirdPartyShareType)type {
    [TDAnalytics enableThirdPartySharing:type properties:@{} withAppId:[self instanceAliasNameOrAppId]];
}

- (void)enableThirdPartySharing:(TAThirdPartyShareType)type customMap:(NSDictionary<NSString *, NSObject *> *)customMap {
    [TDAnalytics enableThirdPartySharing:type properties:customMap withAppId:[self instanceAliasNameOrAppId]];
}
#endif
