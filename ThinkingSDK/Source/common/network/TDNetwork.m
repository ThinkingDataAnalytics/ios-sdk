...
static NSString *kTAIntegrationEncrypt = @"TA-Integration-Encrypt";
...
- (BOOL)flushEvents:(NSArray<NSDictionary *> *)recordArray {
    ...
    BOOL isEncrypt = (recordArray.firstObject[@"ekey"] != nil);
    ...
    [request addValue:@(isEncrypt).stringValue forHTTPHeaderField:kTAIntegrationEncrypt];
